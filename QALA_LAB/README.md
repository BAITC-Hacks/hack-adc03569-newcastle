...
**1.1 нұсқасы: Қазақша / Русский / English.** Ескі нұсқадан көшу: [UPDATE_3_LANGUAGES_KK.md](UPDATE_3_LANGUAGES_KK.md).

125 автоматты тест өтті. Үш тілге арналған тексеру көлемі мен шектеулер: [docs/TRILINGUAL_TEST_REPORT.md](docs/TRILINGUAL_TEST_REPORT.md).
...
![QALA LAB үш тілдегі интерфейсі](docs/i18n/en_catalog.png)
...
| Қазақша/орысша/ағылшынша интерфейс | ҚАЗ / РУС / ENG ауыстырғышы |
